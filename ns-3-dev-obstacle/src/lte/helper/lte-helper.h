...
#include <ns3/handover-stats-calculator.h>
...
/** To add the Propagation Loss Model to Chain
...
/**
   * Enable trace sinks for Handover Trace
   */
  void EnableHandoverTraces(void);

  /**
   * Enable trace sinks for Measurement Receive Trace
   */
  void EnableMesRcvTraces (void);
...
private:
  ...
  /// Container of HO statistics.
  Ptr<HandoverStatsCalculator> m_hndStats;
  ...
  /**
   * Vector to push the Propagation Loss model to chain
   */
